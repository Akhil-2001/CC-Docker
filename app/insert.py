...
mydict = {"title": "Team Heavyweights", "author": "Anibs, akhil, aniach, hs", "createdAt": "27-03-2022"}

db.blog.posts.insert_one({"title": "Team Heavyweights", "author": "Anibs, akhil, aniach, hs", "createdAt": createdAt})
db.close()